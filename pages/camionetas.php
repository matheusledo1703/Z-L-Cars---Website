...
$conn     = conectarBD();
$veiculos = buscarVeiculosPorCategoria($conn, 'camioneta');
$conn->close();
            ...
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-md-8">
                    ...
                    <input type="text" name="busca" class="form-control"
                           placeholder="Ex: Hilux, S10..." value="<?= htmlspecialchars($termoBusca) ?>">
                </div>
                <div class="col-md-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card-custom h-100">
                    <div class="card-placeholder"><i class="bi bi-truck-front"></i></div>
